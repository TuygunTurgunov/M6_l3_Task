...
public class SecurityPcMarket extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth
                ...
                .and()
                .withUser("operator").password(passwordEncoder().encode("operator")).roles("OPERATOR").authorities("READ_ALL_PRODUCT","READ_ONE_PRODUCT","ADD_PRODUCT","ADD_SHOPPING","DELETE_SHOPPING","EDIT_SHOPPING","READ_ALL_SHOPPING","READ_ONE_SHOPPING");
